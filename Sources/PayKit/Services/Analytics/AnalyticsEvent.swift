...
final class CustomerRequestEvent: AnalyticsEvent {
    ...
    private init(
        ...
        super.init(catalog: "mobile_cap_pk_customer_request", fields: Dictionary(uniqueKeysWithValues: [
            ...
            .createActions: createParams?.actions,
            .createChannel: createParams?.channel.rawValue,
            .createRedirectURL: createParams?.redirectURL,
            .createReferenceID: createParams?.referenceID,
            ...
            .customerCashtag: request?.customerProfile?.cashtag,
            .metadata: request?.metadata,
            .updateActions: updateParams?.actions,
            .updateReferenceID: updateParams?.referenceID,
